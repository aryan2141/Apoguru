                            ...
                            <table  id="example" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <td>1</td>
                                        ...
                                        <td> <a href="#"><i class="material-icons">question_answer</i></a> </td>        
                                        <td> <a href="#"><i class="material-icons">edit</i></a> </td>        
                                        <td> <a href="#" onclick="return confirm(&quot;Confirm remove Flag?&quot;)"><i class="material-icons">delete</i></a> </td>        
                                    </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        initComplete: function () {
            ...
            api
                ...
                .each(function (colIdx) {
                    ...
                    var title = $(cell).text();
                    // console.log(title)
                    if(title == "ID" || title == "Edit" || title == "Remove Flag" || title == "Answers"){
                        $(cell).html('');
                    }else{

                                ...
                                <tbody>
                                   ...
                                   @php($count++)
                                    <tr>
                                        ...
                                        <td>{{$user->time}}</td>
                                        @if(Auth::user()->role_as == 0)
                                        <td> <a href="{{route('admin.user.reminder.edit', $user->id)}}"><i class="material-icons">edit</i></a> </td>
                                        <td> <a href="{{route('admin.user.reminder.delete', $user->id)}}" onclick="return confirm(&quot;Confirm delete?&quot;)"><i class="material-icons">delete</i></a> </td>
                                        @endif
                                        @if(Auth::user()->role_as == 1)
                                        <td> <a href="{{route('admin.user.reminder.edit', $user->id)}}"><i class="material-icons">edit</i></a> </td>

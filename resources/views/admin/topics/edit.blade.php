                                    ...
                                    <div class="form-line">
                                        <select id="main_category" class="form-control show-tick" name="main_category_id" required>
                                            ...
                                            @foreach($main_categories as $category)
                                                <option value="{{$category->id}}" @if($topic->main_category_id == $category->id) selected @endif>{{$category->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select id="parent_sub_category" class="form-control show-tick" name="parent_sub_category_id" required>
                                            ...
                                            <option value="{{$topic->parent_sub_category_id}}" selected>{{isset($topic->parentcat->name)?$topic->parentcat->name:''}}</option>
                                        </select>
                                    </div>
                                </div>
                           </div>
                                  ...
                                  <div class="form-group form-float">
                                      <div class="form-line">
                                        <select id="child_sub_category" class="form-control show-tick" name="child_sub_category_id" required>
                                            ...
                                            <option value="{{$topic->parent_sub_category_id}}" selected>{{isset($topic->childSubCategory->name)?$topic->childSubCategory->name:''}}</option>
                                          </select>
                                      </div>
                                  </div>
                              </div>

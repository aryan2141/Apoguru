...
<head>
    ...
    <title>apoGuru - Admin Sign In</title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">apoGuru<b> Admin</b></a>
        </div>
        <div class="card">
          @if ($errors->any())
    ...
    <script src="{{ URL::asset('admin_theme/plugins/jquery-validation/jquery.validate.js')}}"></script>

    <!-- Custom Js -->
    <script src="{{ URL::asset('admin_theme/js/admin.js')}}"></script>
    <script src="{{ URL::asset('admin_theme/js/pages/examples/sign-in.js')}}"></script>
</body>

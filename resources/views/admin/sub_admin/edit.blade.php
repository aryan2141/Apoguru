                          ...
                          @csrf
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
                                    <div class="form-group form-float">
                                      <div class="form-line">
                                          <input type="text" name="email" value="{{$adminedit->email}}"class="form-control" required>
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-8">
                                  <div class="form-group form-float">
                                    <div class="form-line">
                                    <select id="user_id" class="form-control show-tick" name="role_as" value="{{$adminedit->role_as}}" required>
                                            <option value="{{$adminedit->role_as}}">--Select User--</option>
                                            <option value="0" {{ $adminedit->role_as == 0 ? 'selected' : 'Senior Admin' }}>Senior Admin</option>
                                            <option value="1" {{ $adminedit->role_as == 1 ? 'selected' : 'Junior Admin' }}>Junior Admin</option>
                                            <option value="2" {{ $adminedit->role_as == 2 ? 'selected' : 'Customer Care' }}>Customer Care</option>

            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              @endif
                <div class="card">
                    <div class="header">
                        <h2>
                            Edit Parent Sub Category
                        </h2>
                    </div>
                    <div class="body">

                        <form method="post" action="{{ route('admin.category.parent.sub.update', $parent_sub_category->id) }}" enctype="multipart/form-data">
                          @csrf
                            <div class="row clearfix">
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                      ...
                                      <div class="form-line">
                                          <select class="form-control" name="main_category_id" required>
                                            ...
                                            @foreach($main_categories as $category)
                                              <option value="{{$category->id}}" @if($parent_sub_category->main_category_id == $category->id) selected @endif >{{$category->name}}</option>
                                            @endforeach
                                          </select>
                                      </div>
                                  </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="name" value="{{$parent_sub_category->name}}" class="form-control" required>
                                            <label class="form-label">Parent Sub Category Name</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="description" value="{{$parent_sub_category->description}}" class="form-control" required>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="checkbox" id="remember_me_5" name="applicable_to_pq" class="filled-in" @if($parent_sub_category->applicable_to_pq == 1) checked @endif>
                        ...
                        <img src="{{ url('parent_sub_category_images')}}/{{$parent_sub_category->image}}" height="100px" width="100px"/>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                  @foreach ($parent_sub_categories as $category)
                                    <tr>
                                        <td>{{$category->id}}</td>
                                        ...
                                        <td> <img src="{{url('parent_sub_category_images')}}/{{$category->image}}" height="50px" width="50px"/> </td>
                                        @if(Auth::user()->role_as == 0)
                                        <td> <a href="{{route('admin.category.parent.sub.edit', $category->id)}}"><i class="material-icons">edit</i></a> </td>
                                        <td> <a href="{{route('admin.category.parent.sub.delete', $category->id)}}"onclick="return confirm(&quot;Confirm delete?&quot;)"><i class="material-icons">delete</i></a> </td>
                                        @endif
                                        @if(Auth::user()->role_as == 1)
                                        <td> <a href="{{route('admin.category.parent.sub.edit', $category->id)}}"><i class="material-icons">edit</i></a> </td>

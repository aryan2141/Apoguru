              ...
              @endif
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="{{ route('admin.category.child.sub.update', $child_sub_category->id) }}" enctype="multipart/form-data">
                          @csrf
                            <div class="row clearfix">
                              {{-- <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                  <div class="form-group form-float">
                                      <div class="form-line">
                                          <select class="form-control" name="parent_sub_category_id" required>
                                            <option value="">--Select Parent Sub Category--</option>
                                            @foreach($parent_sub_categories as $category)
                                              <option value="{{$category->id}}" @if($child_sub_category->parent_sub_category_id == $category->id) selected @endif>{{$category->name}}</option>
                                            @endforeach
                                          </select>
                                      </div>
                                  </div>
                              </div> --}}
                              <?php //dd($child_sub_category)?>
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                      <select id="main_category" class="form-control show-tick" name="main_category_id" required>
                                          ...
                                          @foreach($main_categories as $category)
                                            <option value="{{$category->id}}" @if($child_sub_category->main_category_id == $category->id) selected @endif>{{$category->name}}</option>
                                          @endforeach
                                      </select>
                                    </div>
                                </div>
                              ...
                              <div class="form-group form-float">
                                  <div class="form-line">
                                      <select id="parent_sub_category" class="form-control show-tick" name="parent_sub_category_id" required>
                                          <option value="">--Select Parent Sub Category--</option>
                                          <option value="{{$child_sub_category->parent_sub_category_id}}" selected>{{isset($child_sub_category->parentSubCategory->name)?$child_sub_category->parentSubCategory->name:''}}</option>
                                        </select>
                                  </div>
                              </div>
                            </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="name" value="{{$child_sub_category->name}}" class="form-control" required>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="description" value="{{$child_sub_category->description}}" class="form-control" required>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="checkbox" id="remember_me_5" name="applicable_to_pq" class="filled-in" @if($child_sub_category->applicable_to_pq == 1) checked @endif >
                        ...
                        <img src="{{ url('child_sub_category_images')}}/{{$child_sub_category->image}}" height="100px" width="100px"/>
                    </div>
                </div>
            </div>
        </div>

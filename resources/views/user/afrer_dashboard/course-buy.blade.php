                    ...
                    <div class="swiper-wrapper">
                      ...
                      <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                        <div class="course__thumb w-img p-relative fix">
                          ...
                          <div class="course__tag">
                            <a href="#" class="sky-blue">BESTSELLER</a>
                          </div>
                        </div>
                        <div class="course__content">
                          <div class="course__meta d-flex align-items-center justify-content-between">
                      ...
                      <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                        <div class="course__thumb w-img p-relative fix">
                          ...
                          <div class="course__tag">
                            <a href="#" class="green">BESTSELLER</a>
                          </div>
                        </div>
                        <div class="course__content">
                          <div class="course__meta d-flex align-items-center justify-content-between">
                      ...
                      <div class="course__item course__item-3 swiper-slide white-bg mb-30 fix">
                        <div class="course__thumb w-img p-relative fix">
                          ...
                          <div class="course__tag">
                            <a href="#" class="blue">BESTSELLER</a>
                          </div>
                        </div>
                        <div class="course__content">
                          <div class="course__meta d-flex align-items-center justify-content-between">
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-4">
          <div class="course__sidebar pl-70 p-relative">
            <div class="course__shape">
              <img class="course-dot" src="{{ URL::asset('assets/img/course/course-dot.png')}}" alt="">
            </div>
            <div class="course__sidebar-widget-2 white-bg mb-20">
              <div class="course__video">
                <div class="course__video-thumb w-img mb-25">
                  <img src="{{ URL::asset('assets/img/course/video/course-video.jpg')}}" alt="">
                ...
                <div class="course__enroll-btn">
                  <a href="{{ route('signup') }}" class="e-btn e-btn-7 w-100">Enroll <i class="far fa-arrow-right"></i></a>
                </div>
              </div>
            </div>
            <div class="course__sidebar-widget-2 white-bg mb-20">
                ...
                <ul>
                  <li>
                    <div class="course__sm d-flex align-items-center mb-30">
                      <div class="course__sm-thumb mr-20">
                        <a href="#">
                        <img src="{{ URL::asset('assets/img/course/sm/course-sm-1.jpg')}}" alt="">
                        </a>
                      </div>
                  ...
                  <li>
                    <div class="course__sm d-flex align-items-center mb-30">
                      <div class="course__sm-thumb mr-20">
                        <a href="#">
                        <img src="{{ URL::asset('assets/img/course/sm/course-sm-2.jpg')}}" alt="">
                        </a>
                      </div>
                      <div class="course__sm-content">
                        <div class="course__sm-rating">
                  ...
                  <li>
                    <div class="course__sm d-flex align-items-center mb-10">
                      <div class="course__sm-thumb mr-20">
                        <a href="#">
                        <img src="{{ URL::asset('assets/img/course/sm/course-sm-3.jpg')}}" alt="">
                        </a>
                      </div>
                      <div class="course__sm-content">
                        <div class="course__sm-rating">
